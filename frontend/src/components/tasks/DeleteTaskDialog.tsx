...
DeleteTaskDialog({organizationId, task, }: Props) {
  ...
  async function handleDelete() {
    ...
    try {
      ...
      toast.success("Task deleted successfully", { position: "top-center", style: { background: "red", color: "white" }, duration: 2000 });
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
       ...
       <Button variant="destructive" className="ml-6 mr-6">Delete Task</Button>

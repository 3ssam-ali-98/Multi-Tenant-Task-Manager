...
def get_task(request, org_id, task_id):
    ...
    if role == 'admin':
        ...
        return get_object_or_404(Task, pk=task_id, organization__pk=org_id, assigned_to=request.user)
...
class TaskList(APIView):
    ...
    def get(self, request, org_id):
        ...
        if role == 'admin':
            ...
            tasks = Task.objects.filter(organization__pk=org_id, assigned_to=request.user)
